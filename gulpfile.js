...
gulp.task('copy:indexhtmlw', function() {
    var gulpCopy = require('gulp-copy');
    return gulp.src("./w/index.html")
        .pipe(gulpCopy("./www/", {
            prefix: 1
...
gulp.task('copy:imgw', function() {
    var gulpCopy = require('gulp-copy');
    return gulp.src("./img/**")
        .pipe(gulpCopy("./www/"));
});

gulp.task('copy:fontsw', function() {
    var gulpCopy = require('gulp-copy');
    return gulp.src("./fonts/**")
        .pipe(gulpCopy("./www/"));
});
...
gulp.task('copyw', ["copy:imgw", "copy:fontsw"]);
...
gulp.task('www', gulpSequence(["copy:imgw", "copy:fontsw", "sass:production", "minify:indexproduction", "minify:views"], 'clean:tmp', "concat:js", 'clean:tmp', "templatecache", "uglify:js", "minify:css", 'clean:tmp', "inlinesource", 'clean:tmp', "copy:indexhtmlw", 'clean:tmp', 'clean:tmp', "zip"));
